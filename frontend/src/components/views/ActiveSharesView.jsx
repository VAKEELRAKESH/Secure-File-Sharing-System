      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-slate-100 flex items-center gap-2.5">
            Active Shares
            <span className="text-xs px-2.5 py-0.5 rounded-full bg-purple-500/10 text-purple-400 border border-purple-500/20 font-mono font-semibold">
              ...
              {sharesList.length === 0 ? (
                <tr>
                  <td colSpan="5" className="px-4 py-12 text-center text-slate-500">
                    No active share links created yet. Click the share button on any file in your vault to create a link.
                  </td>
                </tr>
              ) : (
                    ...
                    <td className="px-4 py-3 text-right">
                      <div className="flex items-center justify-end space-x-2">
                        <button
                          ...
                          className="p-1.5 rounded-lg bg-surface border border-surfaceBorder text-cyan-400 hover:text-cyan-300 transition-colors"
